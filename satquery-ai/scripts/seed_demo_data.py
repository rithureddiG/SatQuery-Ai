...
def seed_demo_scenarios():
    ...
    img1 = db.get(ImageRecord, "img_demo_optical_1") or ImageRecord(
        ...
        crs=meta1.crs.name,
        epsg=meta1.crs.epsg,
        bounds=meta1.bounds.wgs84 if meta1.bounds and meta1.bounds.wgs84 else None,
        resolution=meta1.resolution.__dict__ if meta1.resolution else None,
        modality=meta1.modality.modality,
    ...
    img_opt = db.get(ImageRecord, "img_demo_sentinel2_optical") or ImageRecord(
        ...
        bounds=meta_opt.bounds.wgs84 if meta_opt.bounds and meta_opt.bounds.wgs84 else None,
    ...
    img_sar = db.get(ImageRecord, "img_demo_sentinel1_sar") or ImageRecord(
        ...
        bounds=meta_sar.bounds.wgs84 if meta_sar.bounds and meta_sar.bounds.wgs84 else None,
    ...
    img_flood = db.get(ImageRecord, "img_demo_brahmaputra_flood") or ImageRecord(
        ...
        bounds=meta_flood.bounds.wgs84 if meta_flood.bounds and meta_flood.bounds.wgs84 else None,
