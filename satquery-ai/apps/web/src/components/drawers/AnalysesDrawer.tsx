...
export const CANONICAL_ANALYSES: AnalysisRecord[] = [
  {
    ...
    findingSummary:
      'Siamese ChangeNet detected +backend-measured area of new commercial built-up structures, corroborated by backend-measured backscatter radar double-bounce backscatter.',
    areaHa: '+backend-measured area',
    areaM2: 'backend-measured area',
    confidenceScore: 94,
